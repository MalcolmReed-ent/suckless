 ...
 */
static const char *DEFAULT_WIN_BG     = "#2d2d2d";
static const char *DEFAULT_WIN_FG     = "#f99157";
static const char *DEFAULT_MARK_COLOR = "#6699cc";  /* NULL means it will default to window foreground */
#if HAVE_LIBFONTS
static const char *DEFAULT_BAR_BG     = "#393939";  /* NULL means it will default to window background */
static const char *DEFAULT_BAR_FG     = "#f99157";  /* NULL means it will default to window foreground */
...
static const keymap_t keys[] = {
	...
	/* Adding vim keybindings for next and previous images */
	{ 0,            XK_h,             i_navigate,           -1 },
	{ 0,            XK_l,             i_navigate,           +1 },
	/* Adding arrow keybindings for next and previous images */
	{ 0,            XK_Left,          i_navigate,           -1 },
	{ 0,            XK_Right,         i_navigate,           +1 },

	/* Adding zoom in and out with arrow keys */
	{ 0,            XK_Down,          g_zoom,               -1 },
	{ 0,            XK_Up,            g_zoom,               +1 },
